...
namespace WinSize
{
    public class WindowManager
    {
        public static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Usage: WinSizeCore.exe <WindowTitle> <Width> <Height>");
                Console.WriteLine("   or: WinSizeCore.exe (to enter interactive mode)");
                Console.WriteLine("Example: WinSizeCore.exe \"Untitled - Notepad\" 800 600");
                return;
            }
